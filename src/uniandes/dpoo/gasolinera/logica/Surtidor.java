...
public class Surtidor
{
    ...
    public int venderGasolina(String nombreTipoGasolina, double cantidadEntregada) {
        ...
        double cantidadAnterior = galonesVendidos.getOrDefault(nombreTipoGasolina, 0.0); // Usar 0.0 como default si no existen ventas previas 
        galonesVendidos.put(nombreTipoGasolina, cantidadAnterior + cantidadEntregada); // Agregar la cantidad de entrega al total anterior
